...
struct TrackerOptionsTests {
    ...
    func defaultsMatchReferenceApp() {
        ...
        #expect(options.voiceConfirmationSound == true)
        #expect(options.inputConfirmationSound == false)
        #expect(options.voiceConfirmationVolume == 100)
        #expect(options.inputConfirmationVolume == 100)
